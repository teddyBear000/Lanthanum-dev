...
namespace Lanthanum.Web.Controllers
{
    public class AdminController : Controller
    {
        ...
        //public AdminController(IWebHostEnvironment appEnvironment, ILogger<AdminController> logger, DbRepository<Article> articleRepository, DbRepository<Team> teamRepository, DbRepository<KindOfSport> kindsRepository)
        //{
        //    //_logger = logger;
